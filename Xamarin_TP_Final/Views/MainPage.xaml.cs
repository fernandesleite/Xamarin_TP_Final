...
namespace Xamarin_TP_Final
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        {
            DisplayAlert("Autores", "Bruno Fernandes & Sandyara Peres", "OK");
        }

        async private void OnLivroTapped(object sender, ItemTappedEventArgs args)
        {
            var selecionado = args.Item as Livro;
            string action = await DisplayActionSheet(selecionado.Nome, "Cancelar", "Deletar", "Editar", "Detalhes");
            switch (action)
            {
                case "Deletar":
                ...
                case "Editar":
                    ...
                    break;
                case "Detalhes":
                    await DisplayAlert(selecionado.Nome, "Autor: " + selecionado.Autor + "\nEmail: " + selecionado.Email + "\nISBN: " + selecionado.Isbn, "OK");
                    break;
            }
        }
